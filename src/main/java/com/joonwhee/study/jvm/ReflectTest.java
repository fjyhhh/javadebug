package com.joonwhee.study.jvm;
...
/**
 * 本例的运行JVM参数：-XX:MetaspaceSize=16M -XX:MaxMetaspaceSize=55M -Xms2g -Xmx2g -Xss128k -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=75 -XX:+UseCMSInitiatingOccupancyOnly -XX:+PrintGCTimeStamps -XX:+PrintGCDetails -XX:+PrintHeapAtGC -XX:+PrintTenuringDistribution -Dsun.reflect.inflationThreshold=0 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=D:/dump/java_reflect_heapdump.hprof
